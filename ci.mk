...
ci_release_snapshot:
	docker build . -f .build/Dockerfile --build-arg POSTGRES_VERSION=${POSTGRES_VERSION} --build-arg GO_VERSION=${GO_VERSION} -t ghcr.io/riotkit-org/pgbr:latest
	docker push ghcr.io/riotkit-org/pgbr:latest

ci_release:
	docker tag ghcr.io/riotkit-org/pgbr:latest ghcr.io/riotkit-org/pgbr:$${GITHUB_REF##*/}
	docker push ghcr.io/riotkit-org/pgbr:$${GITHUB_REF##*/}
